...
class Plugin(PluginBase):
    ...
    def __call__(self, **kwargs):
        run(
            ...
            outputs=self.plugin_config.get("outputs", None),
            svg_input_dir=self.plugin_config["svg_input_dir"],
            svg_output_dir=self.plugin_config.get("svg_output_dir", None),
...
def run(
    inputs, outputs=None, *, svg_input_dir, base_url, svg_output_dir=None, kwargs=None
):
    ...
    has_export = svg_output_dir is not None and os.path.abspath(
        svg_input_dir
    ) != os.path.abspath(svg_output_dir)
